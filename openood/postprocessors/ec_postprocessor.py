...
class EcPostprocessor(BasePostprocessor):
    ...
    def setup(self, net: nn.Module, id_loader_dict, ood_loader_dict):
        if not self.setup_flag:
            ...
            # test hb
            all_feats = torch.load("/home/gmr/ood/OpenOOD/f_1k/feat.pth")
            all_labels = torch.load("/home/gmr/ood/OpenOOD/f_1k/label.pth")
            all_preds = torch.load("/home/gmr/ood/OpenOOD/f_1k/pred.pth")
            ...
            for c in range(self.num_classes):
                ...
                center = class_samples.mean(dim=0, keepdim=True)
    ...
    def postprocess(self, net: nn.Module, data: Any):
        ...
        dist = euclidean_metric(features, center_data)

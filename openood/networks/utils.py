...
from .resnet50_512_768 import ResNet50_512
from .resnet50_512_768 import ResNet50_768
from .haf.resnet18_fix import ResNet18_fix
from .haf.resnet50_fix import ResNet50_fix
...
def get_network(network_config):
    ...
    elif network_config.name == 'resnet18_fix':
        net = ResNet18_fix(num_classes=num_classes)

    elif network_config.name == 'resnet50_fix':
         net = ResNet50_fix(num_classes=num_classes)
    ...
    elif network_config.name == 'ResNet50_512':
        net = ResNet50_512(num_classes=num_classes)
    elif network_config.name == 'ResNet50_768':
        net = ResNet50_768(num_classes=num_classes)
